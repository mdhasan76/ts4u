...
const SideNav = () => {
    return (
        <div className='absolute'>
            <div
                class="relative bg-gray-50 dark:bg-slate-900 pattern"
            >
                <nav
                ...
                >
                    ...
                    >
                        ...
                        <small class="text-center text-xs font-medium"> Prfile </small>
                    </Link>
                    ...
                    >
                        ...
                        <small class="text-center text-xs font-medium"> Product </small>
                    </Link>
